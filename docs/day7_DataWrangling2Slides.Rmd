...
```{r}
inner_join(class_grades,GPA,by = c("student_ID"="CMC_ID")) %>% as_tibble()
```
...
```{r}
left_join(class_grades,GPA,by = c("student_ID"="CMC_ID")) %>% as_tibble()
```
...
```{r}
right_join(class_grades,GPA,by = c("student_ID"="CMC_ID")) %>% as_tibble()
```
...
```{r}
full_join(class_grades,GPA,by = c("student_ID"="CMC_ID")) %>% as_tibble()
```
...
```{r}
semi_join(class_grades,GPA,by = c("student_ID"="CMC_ID")) %>% as_tibble()
```
...
```{r}
anti_join(class_grades,GPA,by = c("student_ID"="CMC_ID")) %>% as_tibble()
```
